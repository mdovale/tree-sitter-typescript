...
; --- TSX / JSX (React) — merged for Slates ---
; Derived from nvim-treesitter queries/jsx/highlights.scm (MIT).
; Delimiters use grammar tokens: `</` and `/>` are single anonymous nodes in this grammar.
